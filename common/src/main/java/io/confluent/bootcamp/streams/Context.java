...
public class Context {
    ...
    private static TweetSentimentalAnalysis sentimentalAnalysis = null;
    ...
    public static void setAnalyzer (TweetSentimentalAnalysis sentimentalAnalysis){
        Context.sentimentalAnalysis = sentimentalAnalysis;
    }

    public static TweetSentimentalAnalysis getAnalyzer(){
        return Context.sentimentalAnalysis;
    }
