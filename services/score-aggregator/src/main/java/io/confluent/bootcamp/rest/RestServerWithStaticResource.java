...
public class RestServerWithStaticResource implements Runnable {

    static Logger logger = LoggerFactory.getLogger(RestServerWithStaticResource.class.getName());
    ...
    public void run() {
        ...
        ContextHandler resourceCtx = new ContextHandler(resourceHandler, "/*");

        HandlerList handlerList = new HandlerList(resourceHandler, resourceCtx, servletCtx);
